      ...
      {isOpen && (
        <div className="md:hidden">
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3 bg-white shadow-lg">
            <button
              onClick={() => scrollToSection("home")}
              className="text-slate-700 hover:text-primary-600 block px-3 py-2 text-base font-medium w-full text-left"
            >
              {t('home')}
            </button>
            <button
            ...
            <Link
              href="/blog"
              className="text-slate-600 hover:text-primary-600 block px-3 py-2 text-base font-medium"
