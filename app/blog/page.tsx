...
const generateBlogPost = (id: number) => {
  const categories = ["Construction", "Sustainability", "Interior Design", "Architecture"];
  const images = [
...
export default function BlogPage() {
  ...
  const categoryKeys = ["all", "construction", "sustainability", "interior", "architecture"] as const;
  ...
  const filteredPosts = selectedCategory === "all" 
    ? allPosts 
    : allPosts.filter(post => post.category.toLowerCase() === selectedCategory.replace("interior", "interior design"));

  const getCategoryDisplayName = (categoryKey: string) => {
    switch (categoryKey) {
      case "all": return t("allCategories") || "All";
      case "construction": return t("construction") || "Construction";
      case "sustainability": return t("sustainability") || "Sustainability";
      case "interior": return t("interior") || "Interior Design";
      case "architecture": return t("architecture") || "Architecture";
...
{t("home")}
          ...
          <p className="text-xl text-slate-600 max-w-3xl">
            {t("blogDescription") || "Stay updated with the latest insights, trends, and innovations in construction and design."}
          </p>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {isError && (
          <div className="text-center py-12">
            <p className="text-slate-600 text-lg">Error loading blog posts. Please try again.</p>
          </div>
        )}
        ...
        {!isLoading && !isError && filteredPosts.length === 0 && (
          <div className="text-center py-12">
            <p className="text-slate-600 text-lg">No blog posts found for the selected category.</p>
          </div>
        )}
      </div>
